...
<head>
    ...
    <title>DataTables detail post</title>
</head>
<body>
    <div class="container">
        <div class="row panel">
            <div class="panel-content">
                <div class="panel-heading">
                    <div class="panel-title">
                      ...
                      {{ $values->numCompte}}  {{ $values->intitulePost }}
                      @endforeach
               ...
               <div class="panel-content" style="display:inline-block;  width:100%"><br>
                <div class="panel" style=" width:50%; display:inline-block">
                        @foreach ($post as $values )
                            ...
                            <label for="">Sens: {{ $values->sensPost }}</label><br><br>
                            <label for="">Categorie : {{ $values->categorie }}</label><br><br>
                        @endforeach
                    </div>
